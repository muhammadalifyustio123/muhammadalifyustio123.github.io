...
<head>
    <title>MALIFY | TRACK ORDER</title>
    ...
    <div class="title">Purchase Reciept</div>
            ...
            <div class="pricing">
                <div class="row">
                    ...
                    <div class="col-3">
                        <span id="price">Rp. <?php echo $total;?></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-9">
            ...
            <div class="total">
                <div class="row">
                    <div class="col-9"></div>
                    <div class="col-3"><big>Rp. <?php echo $total;?></big></div>
                </div>
            </div>
            <div class="tracking">
                ...
                <?php }
                    ...
                    {?>
                        <div style="text-align:center;">
                            ...
                            <h5>If you feel this is an error, please contact our Email.
                        </div>
