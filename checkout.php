                              ...
                              <ul class="list-group">
                                   <li class="list-group-item">
                                        <div class="row">
                                             ...
                                             <div class="col-xs-6 text-right">
                                                  <strong>Rp. <?php echo $sub_total; ?></strong>
                                             </div>
                                        </div>
                                   </li>
                                   ...
                                   <li class="list-group-item">
                                        <div class="row">
                                             ...
                                             <div class="col-xs-6 text-right">
                                                  <strong>Rp. <?php echo (($sub_total * 5)/100); ?></strong>
                                             </div>
                                        </div>
                                   </li>
                                   ...
                                   <li class="list-group-item">
                                        <div class="row">
                                             ...
                                             <div class="col-xs-6 text-right">
                                                  <strong>Rp. <?php echo $sub_total + (($sub_total * 5)/100); ?></strong>
                                             </div>
                                        </div>
                                   </li>
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                             <div class="form-group">
                                                  ...
                                                  <select class="form-control" name="payment">
                                                       ...
                                                       <option value="Virtual Account" disabled>Virtual Account</option>
                                                  </select>
                                             </div>
                                        </div>
